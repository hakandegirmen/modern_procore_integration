import requests
import json
from procore_integration.api_handler.models import PlatformUser
import time
...
class Procore:
    ...
    def get_access_token(self, authorization_code):
        ...
        data = {'code': authorization_code,
                ...
                'redirect_uri': 'http://127.0.0.1:8002/platform_users/receive_authorization/'}
